...
public class BankDatabase
{
    ...
    public boolean overdrawnAvailability(int userAccountNumber) {
        return getAccount(userAccountNumber).canOverdrawn();
    }

    public double getOverdrawnLimit(int userAccountNumber) {
        if(overdrawnAvailability(userAccountNumber))
            return ((CurrentAccount) getAccount(userAccountNumber)).getCurrentAccount();
        else
            return 0;
    }
